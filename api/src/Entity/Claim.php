 ...
 * @ApiFilter(SearchFilter::class, properties={"person": "partial", "property": "exact"})
 */
class Claim
{
    /**
    ...
    /**
     * @var string The property of this Claim.
     *
    ...
    /**
     * @var array The data (Value) of this Claim.
     *
     * @Assert\NotNull
     * @Groups({"read","write"})
    ...
    /**
     * @var string The jwt token of this Claim.
     *
