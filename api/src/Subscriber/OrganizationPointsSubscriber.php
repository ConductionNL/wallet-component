...
class OrganizationPointsSubscriber implements EventSubscriberInterface
{
    ...
    public function applicationPoints(ViewEvent $event)
    {
        ...
        if ($event->getRequest()->getMethod() == 'GET' && $event->getRequest()->get('_route') == 'api_authorizations_get_points_by_organization_collection') {
            ...
            $points = $this->pointService->getPointsByOrganization($organization);
